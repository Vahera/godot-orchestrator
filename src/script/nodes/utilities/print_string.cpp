...
void OScriptNodePrintString::allocate_default_pins()
{
    ...
    create_input_pin(PT_Data, "Text", Variant::STRING, "Hello");
    create_input_pin(PT_Data, "PrintToScreen", Variant::BOOL, true);
    create_input_pin(PT_Data, "PrintToLog", Variant::BOOL, true);
    create_input_pin(PT_Data, "TextColor", Variant::COLOR, Color(1, 1, 1));
    create_input_pin(PT_Data, "Duration", Variant::FLOAT, 2.f);
